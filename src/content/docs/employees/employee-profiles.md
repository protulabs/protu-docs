...
description: How to read and use your team members' behavioural profiles.
---
...
| Assessed employees | Confidence |
|-------------------|------------|
| **50+** | Full: percentiles are reliable |
| **20-49** | Approximate: directional but sample is small |
| **10-19** | Limited: treat as indicative only |
...
|------|---------|---------------|
| **Develop** | 1:1 prep and development planning | A specific capability gap, context for why it matters, and a conversation starter question |
| **Focus** | Project assignments and task matching | Situations where this person adds unique value based on their strengths |
...
Stretch warnings appear in [Team Intelligence](/teams/intelligence/team-intelligence/) narratives, including when a team has too many stretched members or when an individual's stretch is worsening.
...
### Bridge indicators on the profile
...
This detail appears in [Team Intelligence](/teams/intelligence/team-intelligence/) views rather than on individual profiles.
...
For full privacy details, see [Privacy & GDPR](/security/privacy/).
